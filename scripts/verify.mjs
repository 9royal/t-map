...
if (pkg.version !== '1.5.3' || version !== 'T map v1.05.3' || info.version !== '1.05.3' ||
    !html.includes('T map v1.05.3') || !app.includes("const VERSION = '1.05.3'") ||
    !html.includes('screen-catalog') || !html.includes('map-registry.js?v=1.05.3') || !html.includes('map-engine.js?v=1.05.3') ||
...
if (!Array.isArray(info.platformMaps) || info.platformMaps.length !== 3 || info.readyMaps?.[0] !== 'taiwan') {
  throw new Error('v1.05.3 build-info 多地圖平台資料異常。');
}
console.log('✓ v1.05.3 版本與多地圖平台資訊一致');
