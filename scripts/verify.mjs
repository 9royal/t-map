...
if (pkg.version !== '1.4.4' || version !== 'T map v1.04.4' || info.version !== '1.04.4' || !html.includes('T map v1.04.4') || /T map v1\.0[0-3](?!\.)/.test(html) || !app.includes("const VERSION = '1.04.4'") || !helper.includes('geometryDistance') || !mobile.includes('magnifierGeometry') || !mobile.includes('drawerStateFromSwipe') || !speech.includes('taiwanese') || !speech.includes('english') || !helper.includes('correctHintSurface') || !helper.includes('magnifierHintName') || !app.includes('applyMagnifierCorrectHint') || !app.includes('centerTarget = hitRegionAt') || !html.includes('style.css?v=1.04.4') || !html.includes('app.js?v=1.04.4')) {
  throw new Error('v1.04.4 版本資訊不一致。');
}
console.log('✓ v1.04.4 版本資訊一致');
